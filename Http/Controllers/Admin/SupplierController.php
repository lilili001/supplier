...
class SupplierController extends AdminBaseController
{
    ...
    public function index()
    {
        ...
        return view('supplier::admin.suppliers.index', compact('suppliers'));
    }
    ...
    {
        return view('supplier::admin.suppliers.create');
    }
    ...
    {
        return view('supplier::admin.suppliers.edit', compact('supplier'));
    }
    ...
    {
         $this->supplier->bulkdelete($request->get('ids'));
